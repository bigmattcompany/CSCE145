...
public class ConcertPromoter {
	...
	public static void main(String[] args) {
		...
		while(input.equalsIgnoreCase("quit")!= true)
		{
			...
			System.out.println("Has sold "+concert.gettixbyphone()+" tickets by phone");
			System.out.println("Has sold "+concert.gettixbyven()+" tickets at the venue");
			...
			case 2:
				...
				concert.setpricephone(key.nextDouble());
				break;
			case 3:
				System.out.println("Enter the new price at the venue");
				concert.setpriceven(key.nextDouble());
				break;
			case 4:
